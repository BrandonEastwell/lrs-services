    ...
    return (
        <>
            <motion.div
                ...
                className="fixed w-full overflow-hidden backdrop-blur-[15px] bg-white bg-opacity-20"
            >
            ...
            <div className="bg-[url('../assets/pressure.png')] w-full h-screen bg-right bg-cover pt-[100px] px-[30px]">
